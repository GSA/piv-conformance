...
public interface IPIVApplication {
	 ...
	 *
	 * @param cardHandle            Opaque identifier of the card to be acted upon
	 ...
	 */
	MiddlewareStatus pivSelectCardApplication(CardHandle cardHandle, ApplicationAID applicationAID,
	 ...
	 * @param cardHandle     Opaque identifier of the card to be acted upon as
	 *                       returned by pivConnect.
	 * @param authenticators A sequence of zero or more BER-TLV encoded
	 *                       authenticators to be used to authenticate and set
	 *                       security state/status in the PIV Card Application
	 *                       contex
	 * @return MiddlewareStatus value indicating the result of the function call
	 */
	 ...
	 * 
	 * @param cardHandle Opaque identifier of the card to be acted upon as returned
	 *                   by pivConnect.
	...
	/**
	 * pivLogoutOfCardApplication from SP800-73-4 part 3 section 3.2.5 - reset
	 * application security status of PIV card application
	 *
	 * @param cardHandle Opaque identifier of the card to be acted upon as returned
	 *                   by pivConnect.
	 * @return MiddlewareStatus value indicating the result of the function call
	 ...
	 * @param cardHandle          Opaque identifier of the card to be acted upon as
	 *                            returned by pivConnect.
	 * @param algorithmIdentifier Identifier of the cryptographic algorithm to be
	 *                            used for the cryptographic operation.
	 * @param keyReference        Identifier of the on-card key to be used for the
	 *                            cryptographic operation.
	 * @param algorithmInput      Sequence of bytes used as the input to the
	 *                            cryptographic operation stored in PIVDataObject
	 *                            object.
	 * @param algorithmOutput     Sequence of bytes output by the cryptographic
	 *                            operation stored in PIVDataObject object.
	 * @return MiddlewareStatus value indicating the result of the function call
	 */
	MiddlewareStatus pivCrypt(CardHandle cardHandle, byte algorithmIdentifier, byte keyReference,
	 ...
	 * @param publicKey              BER-TLV data objects defining the public key of
	 *                               the generated key pair stored in PIVDataObject
	 *                               object.
	 * @return MiddlewareStatus value indicating the result of the function call
	 */
	MiddlewareStatus pivGenerateKeyPair(CardHandle cardHandle, byte keyReference, byte cryptographicMechanism,
