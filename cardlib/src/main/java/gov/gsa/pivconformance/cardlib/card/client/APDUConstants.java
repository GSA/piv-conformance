...
public class APDUConstants {
	...
	public static final HashMap<Integer, String> containerIdOidMap = new HashMap<Integer, String>() {
		...
		{
			put(Integer.valueOf(PIV_AUTHENTICATION_KEY_ID), X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID);
			put(Integer.valueOf(DIGITAL_SIGNATURE_KEY_ID), X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID);
			put(Integer.valueOf(KEY_MANAGEMENT_KEY_ID), X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID);
			put(Integer.valueOf(CARD_AUTHENTICATION_KEY_ID), X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_1), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_1_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_2), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_2_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_3), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_3_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_4), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_4_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_5), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_5_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_6), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_6_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_7), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_7_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_8), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_8_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_9), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_9_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_10), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_10_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_11), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_11_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_12), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_12_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_13), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_13_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_14), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_14_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_15), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_15_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_16), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_16_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_17), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_17_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_18), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_18_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_19), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_19_OID);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_20), RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_20_OID);
		}
	};
	...
	public static final HashMap<String, Integer> oidToContainerIdMap = new HashMap<String, Integer>() {
		...
		{
			put(X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID, Integer.valueOf(PIV_AUTHENTICATION_KEY_ID));
			put(X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID, Integer.valueOf(DIGITAL_SIGNATURE_KEY_ID));
			put(X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID, Integer.valueOf(KEY_MANAGEMENT_KEY_ID));
			put(X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID, Integer.valueOf(CARD_AUTHENTICATION_KEY_ID));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_1_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_1));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_2_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_2));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_3_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_3));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_4_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_4));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_5_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_5));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_6_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_6));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_7_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_7));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_8_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_8));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_9_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_9));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_10_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_10));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_11_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_11));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_12_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_12));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_13_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_13));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_14_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_14));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_15_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_15));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_16_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_16));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_17_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_17));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_18_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_18));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_19_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_19));
			put(RETIRED_X_509_CERTIFICATE_FOR_KEY_MANAGEMENT_20_OID, Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_20));
		}
	};
	...
	public static final HashMap<Integer, ContainerPurpose> containerPurposeMap = new HashMap<Integer, ContainerPurpose>() {
		...
		{
			put(Integer.valueOf(DIGITAL_SIGNATURE_KEY_ID), ContainerPurpose.SIGNATURE);
			put(Integer.valueOf(KEY_MANAGEMENT_KEY_ID), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(CARD_AUTHENTICATION_KEY_ID), ContainerPurpose.SIGNATURE);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_1), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_2), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_3), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_4), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_5), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_6), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_7), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_8), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_9), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_10), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_11), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_12), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_13), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_14), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_15), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_16), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_17), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_18), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_19), ContainerPurpose.ENCRYPTION);
			put(Integer.valueOf(RETIRED_KEY_MANAGEMENT_KEY_ID_20), ContainerPurpose.ENCRYPTION);
		}
	};
