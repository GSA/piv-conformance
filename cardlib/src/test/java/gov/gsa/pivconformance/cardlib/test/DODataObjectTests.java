    ...
    private static Stream<Arguments> dataObjectTestProvider() {
        return Stream.of(
                Arguments.of(APDUConstants.DISCOVERY_OBJECT_OID,
                        "gov/gsa/pivconformance/cardlib/test/gov/gsa/pivconformance/cardlib/test/gsa-icam-card-builder/cards/ICAM_Card_Objects/01_Golden_PIV/1 - Discovery Object"),
                Arguments.of(APDUConstants.DISCOVERY_OBJECT_OID,
