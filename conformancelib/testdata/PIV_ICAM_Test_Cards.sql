...
INSERT INTO "TestCases" VALUES(355, NULL,'11.1.2.1.1','Key Usage extension is present','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
...
INSERT INTO "TestCases" VALUES(363, NULL,'11.1.2.3.3','AIA uniformResourceIdentifier protocol is http','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(364, NULL,'11.1.2.4','PIV interim extension is present','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(365, NULL,'11.1.2.5','Private key corresponds to the public key contained in the certificate as the signature verification succeeds.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(366, NULL,'11.1.2.6','Subject Alternate Name','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(367, NULL,'11.1.2.6.1','GeneralName field exists that contains an otherName with a type-id asserting the pivFASC-N OID. The value field of this otherName contains the FASC-N for the cardholder which matches the FASC-N obtained from parsing the CHUID.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(368, NULL,'11.1.2.6.2','GeneralName field exists that contain a URI asserting a Card UUID as specified by [RFC4122, Section 3] that matches the GUID value in the CHUID.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(369, NULL,'11.1.2.7','Expiration date of the PIV authentication certificate is not beyond the expiration date of the CHUID i.e. the PIV card.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(370, NULL,'11.1.2.8','Exponent of the RSA asymmetric key for PIV authentication is equal to 65,537.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(371, NULL,'11.1.2.9','CRL Distribution Point','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(372, NULL,'11.1.2.9.1','URI is present with the http scheme.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(373, NULL,'11.1.2.9.2','URI points only to files with .crl extensions.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(374, NULL,'11.1.2.10','Authority Information Access','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(375, NULL,'11.1.2.10.1','authorityInformationAccess extension is present','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(376, NULL,'11.1.2.10.2','An accessMethod containing id-ad-caIssuers is present','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(377, NULL,'11.1.2.10.3','The accessLocation for this AccessMethod is of type uniformResourceIdentifier','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(378, NULL,'11.1.2.10.4','URI scheme is http (not https)','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(379, NULL,'11.1.2.10.5','File contains a CMS a certs-only CMS message (see RFC 3851).','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(380, NULL,'11.2 Digital Signature Cert','Digital Signature Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(381, NULL,'11.2.1','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(382, NULL,'11.2.1.1','The signatureAlgorithm value is in accordance with Table 3-3 of SP80078. If the algorithm value is id-RSASSA-PSS, verify that the signature->parameters field is populated with SHA-256 (OID = 2.16.840.1.101.3.4.2.1). For the other RSA algorithms, the parameters field is populated with NULL. For ECDSA, the parameters field is absent.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(383, NULL,'11.2.1.2','The digital signature key is generated using an allowed asymmetric key algorithm.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(384, NULL,'11.2.1.3','The key size used is in accordance with Table 3-1 of SP80078.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(385, NULL,'11.2.2','Data Integrity Checks','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(386, NULL,'11.2.2.1','Key Usage','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(387, NULL,'11.2.2.1.1','Key Usage extension is present','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(388, NULL,'11.2.2.1.2','digitalSignature and nonRepudiation bits have been set.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(389, NULL,'11.2.2.1.3','No other Key Usage bits are set.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
...
INSERT INTO "TestCases" VALUES(410, NULL,'11.3.2.1.1','Key Usage extension is present','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(411, NULL,'11.3.2.1.1.1','If the public key algorithm is RSA, then the keyUsage extension asserts the keyEncipherment bit.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(412, NULL,'11.3.2.1.1.2','If the algorithm is Elliptic Curve key, then the keyUsage extension asserts the keyAgreement bit.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(413, NULL,'11.3.2.1.1.3','No other Key Usage bits are set.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(414, NULL,'11.3.2.2','The private key corresponds to the public key contained in the certificate as the signature verification succeeds.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(415, NULL,'11.3.2.3','Exponent of the RSA asymmetric key for key management is equal to 65,537.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(416, NULL,'11.3.2.4','policyIdentifier field in the certificatePolicies extension asserts one of the following: id-fpki-common-hardware or id-fpki-common-High.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(417, NULL,'11.3.2.5','CRL Distribution Point','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(418, NULL,'11.3.2.5.1','URI is present with the http scheme.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(419, NULL,'11.3.2.5.2','URI points only to files with .crl extensions.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(420, NULL,'11.3.2.6','Authority Information Access','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(421, NULL,'11.3.2.6.1','authorityInformationAccess extension is present','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(422, NULL,'11.3.2.6.2','authorityInfoAccess field contains an id-ad-caIssuers','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(423, NULL,'11.3.2.6.3','The accessLocation for this AccessMethod is of type uniformResourceIdentifier','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(424, NULL,'11.3.2.6.4','URI scheme is http (not https)','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(425, NULL,'11.3.2.6.5','File contains a CMS a certs-only CMS message (see RFC 3851).','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(426, NULL,'11.4 Card Auth Cert','Card Authentication Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(427, NULL,'11.4.1','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(428, NULL,'11.4.1.1','If the algorithm value is id-RSASSA-PSS, verify that the signature->parameters field is populated with SHA-256 (OID = 2.16.840.1.101.3.4.2.1). For the other RSA algorithms, the parameters field is populated with NULL. For ECDSA, the parameters field is absent.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(429, NULL,'11.4.1.2','The card authentication key is generated using the allowed asymmetric key algorithm.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(430, NULL,'11.4.1.3','The key sizes used are in accordance with Table 3-1 of SP80078.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(431, NULL,'11.4.2','Data Integrity Checks','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(432, NULL,'11.4.2.1','Key Usage','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(433, NULL,'11.4.2.1.1','Key Usage extension is present','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(434, NULL,'11.4.2.1.2','The digitalSignature bit has been set.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(435, NULL,'11.4.2.1.3','No other bits have been set.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(436, NULL,'11.4.2.2','policyIdentifier field in the certificatePolicies extension asserts id-fpki-common-cardAuth.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(437, NULL,'11.4.2.3','Extended Key Usage','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(438, NULL,'11.4.2.3.1','Extended key usage (extKeyUsage) extension is present and maked critical','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(439, NULL,'11.4.2.3.2','Extended key usage (extKeyUsage) extension asserts id-PIV-cardAuth','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(440, NULL,'11.4.2.3.3','Extended key usage extension does not assert any other OIDs.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(441, NULL,'11.4.2.4','Authority Information Access','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(442, NULL,'11.4.2.4.1','authorityInformationAccess extension is present','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(443, NULL,'11.4.2.4.2','authorityInfoAccess field contains an id-ad-ocsp','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(444, NULL,'11.4.2.4.3','The accessLocation for this AccessMethod is of type uniformResourceIdentifier','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(445, NULL,'11.4.2.4.4','URI scheme is http (not https)','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(446, NULL,'11.4.2.5','PIV interim extension is present','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(447, NULL,'11.4.2.6','The private key corresponds to the public key contained in the certificate as the signature verification succeeds.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(448, NULL,'11.4.2.7','Subject Alternate Name','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(449, NULL,'11.4.2.7.1','GeneralName field exists that contains an otherName with a type-id asserting the pivFASC-N OID. The value field of this otherName contains the FASC-N for the cardholder which matches the FASC-N obtained from parsing the CHUID.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(450, NULL,'11.4.2.7.2','GeneralName field exists that contain a URI asserting a Card UUID as specified by [RFC4122, Section 3] that matches the GUID value in the CHUID.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(451, NULL,'11.4.2.7.3','No other name forms appear in the subjectAltName extension.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(452, NULL,'11.4.2.8','Exponent of the RSA asymmetric key for key management is equal to 65,537.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(453, NULL,'11.4.2.9','CRL Distribution Point','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(454, NULL,'11.4.2.9.1','URI is present with the http scheme.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(455, NULL,'11.4.2.9.2','URI points only to files with .crl extensions.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(456, NULL,'11.4.2.10','Authority Information Access (85B-4)','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(457, NULL,'11.4.2.10.5','File contains a CMS a certs-only CMS message (see RFC 3851).','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(458, NULL,'11.5 Secure Messaging CVC','Secure Messaging Card Verifiable Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(459, NULL,'11.5.1','Secure Messaging CVC Profile Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(460, NULL,'11.5.2','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(461, NULL,'11.5.3','Data Integrity Checks','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(462, NULL,'11.6 Intermediate CVC','Intermediate Card Verifiable Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(463, NULL,'11.6.1','Intermediate CVC Profile Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(464, NULL,'11.6.2','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(465, NULL,'11.7 Content Signing Cert','X.509 Certificate for Content Signing','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(466, NULL,'11.7.1','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(467, NULL,'11.7.1.1','If the algorithm value is id-RSASSA-PSS, verify that the signature->parameters field is populated with SHA-256 (OID = 2.16.840.1.101.3.4.2.1). For the other RSA algorithms, the parameters field is populated with NULL. For ECDSA, the parameters field is absent.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(468, NULL,'11.7.1.2','The card authentication key is generated using the allowed asymmetric key algorithm.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(469, NULL,'11.7.1.3','The key sizes used are in accordance with Table 3-1 of SP80078.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(470, NULL,'11.7.2','Data Integrity Checks','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(471, NULL,'11.7.2.1','Key Usage','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(472, NULL,'11.7.2.1.1','Key Usage extension is present','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(473, NULL,'11.7.2.1.2','digitalSignature and nonRepudiation bits have been set','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(474, NULL,'11.7.2.1.3','No other bits have been set.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
...
INSERT INTO "TestsToSteps" VALUES(287, 143,355,0,NULL);
INSERT INTO "TestsToSteps" VALUES(288, 145,356,0,NULL);
INSERT INTO "TestsToSteps" VALUES(289, 145,357,0,NULL);
INSERT INTO "TestsToSteps" VALUES(290, 146,358,0,NULL);
INSERT INTO "TestsToSteps" VALUES(291, 147,359,0,NULL);
INSERT INTO "TestsToSteps" VALUES(292, 148,361,0,NULL);
INSERT INTO "TestsToSteps" VALUES(293, 149,362,0,NULL);
INSERT INTO "TestsToSteps" VALUES(294, 164,363,0,NULL);
INSERT INTO "TestsToSteps" VALUES(295, 151,364,0,NULL);
INSERT INTO "TestsToSteps" VALUES(296, 152,365,0,NULL);
INSERT INTO "TestsToSteps" VALUES(297, 153,367,0,NULL);
INSERT INTO "TestsToSteps" VALUES(298, 168,368,0,NULL);
INSERT INTO "TestsToSteps" VALUES(299, 154,369,0,NULL);
INSERT INTO "TestsToSteps" VALUES(300, 155,370,0,NULL);
INSERT INTO "TestsToSteps" VALUES(301, 150,372,0,NULL);
INSERT INTO "TestsToSteps" VALUES(302, 165,373,0,NULL);
INSERT INTO "TestsToSteps" VALUES(303, 148,375,0,NULL);
INSERT INTO "TestsToSteps" VALUES(304, 163,376,0,NULL);
INSERT INTO "TestsToSteps" VALUES(305, 150,377,0,NULL);
INSERT INTO "TestsToSteps" VALUES(306, 164,378,0,NULL);
INSERT INTO "TestsToSteps" VALUES(307, 166,379,0,NULL);
INSERT INTO "TestsToSteps" VALUES(308, 141,382,0,NULL);
INSERT INTO "TestsToSteps" VALUES(309, 139,383,0,NULL);
INSERT INTO "TestsToSteps" VALUES(310, 139,384,0,NULL);
INSERT INTO "TestsToSteps" VALUES(311, 143,387,0,NULL);
INSERT INTO "TestsToSteps" VALUES(312, 145,388,0,NULL);
INSERT INTO "TestsToSteps" VALUES(313, 145,389,0,NULL);
INSERT INTO "TestsToSteps" VALUES(314, 152,390,0,NULL);
INSERT INTO "TestsToSteps" VALUES(315, 154,391,0,NULL);
INSERT INTO "TestsToSteps" VALUES(316, 155,392,0,NULL);
INSERT INTO "TestsToSteps" VALUES(317, 147,393,0,NULL);
INSERT INTO "TestsToSteps" VALUES(318, 150,395,0,NULL);
INSERT INTO "TestsToSteps" VALUES(319, 165,396,0,NULL);
INSERT INTO "TestsToSteps" VALUES(320, 148,398,0,NULL);
INSERT INTO "TestsToSteps" VALUES(321, 163,399,0,NULL);
INSERT INTO "TestsToSteps" VALUES(322, 150,400,0,NULL);
INSERT INTO "TestsToSteps" VALUES(323, 164,401,0,NULL);
INSERT INTO "TestsToSteps" VALUES(324, 166,402,0,NULL);
INSERT INTO "TestsToSteps" VALUES(325, 141,405,0,NULL);
INSERT INTO "TestsToSteps" VALUES(326, 139,406,0,NULL);
INSERT INTO "TestsToSteps" VALUES(327, 139,407,0,NULL);
INSERT INTO "TestsToSteps" VALUES(328, 143,410,0,NULL);
INSERT INTO "TestsToSteps" VALUES(329, 145,411,0,NULL);
INSERT INTO "TestsToSteps" VALUES(330, 145,412,0,NULL);
INSERT INTO "TestsToSteps" VALUES(331, 145,413,0,NULL);
INSERT INTO "TestsToSteps" VALUES(332, 152,414,0,NULL);
INSERT INTO "TestsToSteps" VALUES(333, 155,415,0,NULL);
INSERT INTO "TestsToSteps" VALUES(334, 147,416,0,NULL);
INSERT INTO "TestsToSteps" VALUES(335, 150,418,0,NULL);
INSERT INTO "TestsToSteps" VALUES(336, 165,419,0,NULL);
INSERT INTO "TestsToSteps" VALUES(337, 148,421,0,NULL);
INSERT INTO "TestsToSteps" VALUES(338, 163,422,0,NULL);
INSERT INTO "TestsToSteps" VALUES(339, 150,423,0,NULL);
INSERT INTO "TestsToSteps" VALUES(340, 164,424,0,NULL);
INSERT INTO "TestsToSteps" VALUES(341, 166,425,0,NULL);
INSERT INTO "TestsToSteps" VALUES(342, 141,428,0,NULL);
INSERT INTO "TestsToSteps" VALUES(343, 139,429,0,NULL);
INSERT INTO "TestsToSteps" VALUES(344, 139,430,0,NULL);
INSERT INTO "TestsToSteps" VALUES(345, 143,433,0,NULL);
INSERT INTO "TestsToSteps" VALUES(346, 145,434,0,NULL);
INSERT INTO "TestsToSteps" VALUES(347, 145,435,0,NULL);
INSERT INTO "TestsToSteps" VALUES(348, 147,436,0,NULL);
INSERT INTO "TestsToSteps" VALUES(349, 160,438,0,NULL);
INSERT INTO "TestsToSteps" VALUES(350, 161,439,0,NULL);
INSERT INTO "TestsToSteps" VALUES(351, 161,440,0,NULL);
INSERT INTO "TestsToSteps" VALUES(352, 148,442,0,NULL);
INSERT INTO "TestsToSteps" VALUES(353, 149,443,0,NULL);
INSERT INTO "TestsToSteps" VALUES(354, 150,444,0,NULL);
INSERT INTO "TestsToSteps" VALUES(355, 150,445,0,NULL);
INSERT INTO "TestsToSteps" VALUES(356, 151,446,0,NULL);
INSERT INTO "TestsToSteps" VALUES(357, 152,447,0,NULL);
INSERT INTO "TestsToSteps" VALUES(358, 153,449,0,NULL);
INSERT INTO "TestsToSteps" VALUES(359, 168,450,0,NULL);
INSERT INTO "TestsToSteps" VALUES(360, 169,451,0,NULL);
INSERT INTO "TestsToSteps" VALUES(361, 155,452,0,NULL);
INSERT INTO "TestsToSteps" VALUES(362, 150,454,0,NULL);
INSERT INTO "TestsToSteps" VALUES(363, 165,455,0,NULL);
INSERT INTO "TestsToSteps" VALUES(364, 166,457,0,NULL);
INSERT INTO "TestsToSteps" VALUES(365, 141,467,0,NULL);
INSERT INTO "TestsToSteps" VALUES(366, 139,468,0,NULL);
INSERT INTO "TestsToSteps" VALUES(367, 139,469,0,NULL);
INSERT INTO "TestsToSteps" VALUES(368, 143,472,0,NULL);
INSERT INTO "TestsToSteps" VALUES(369, 145,473,0,NULL);
