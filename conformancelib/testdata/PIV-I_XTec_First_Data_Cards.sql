...
INSERT INTO "TestStepParameters" VALUES(20, 147,NULL,'X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID:2.16.840.1.114027.200.3.10.7.2|2.16.840.1.114027.200.3.10.7.6',1);
INSERT INTO "TestStepParameters" VALUES(21, 147,NULL,'X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID:2.16.840.1.114027.200.3.10.7.2|2.16.840.1.114027.200.3.10.7.6',2);
INSERT INTO "TestStepParameters" VALUES(22, 147,NULL,'X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID:2.16.840.1.114027.200.3.10.7.4|2.16.840.1.114027.200.3.10.7.6|2.16.840.1.114027.200.3.10.7.2',3);
...
INSERT INTO "TestCases" VALUES(293, NULL,'10.2.1.15','The signed attribute entryUUID matches GUID read from CHUID container.','CARDHOLDER_FINGERPRINTS_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(294, NULL,'10.3 Facial Image','Biometric Facial Image','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(295, NULL,'10.3.1','Signature Block Contents','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(296, NULL,'10.3.1.1','CBEFF_SIGNATURE_BLOCK is present in the biometric CBEFF structure containing an asymmetric digital signature that is implemented as a SignedData type according to RFC 5652.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(297, NULL,'10.3.1.2','PKCS#7 version is set to 3','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(298, NULL,'10.3.1.3','digestAlgorithms field value of the SignedData is in accordance with Table 3-2 of SP80078.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(299, NULL,'10.3.1.4','Ensure encapsulated content is absent and eContentType is id-PIV-CHUIDSecurityObject for CHUID and id-PIV-biometricObject for biometric objects in encapContentInfo','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(300, NULL,'10.3.1.5','The crls field is omitted from the SignedData.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(301, NULL,'10.3.1.6','The signerInfos field in the SignedData contains a single SignerInfo.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(302, NULL,'10.3.1.7.1','SignerId uses ths IssuerAndSerialNumber choice','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(303, NULL,'10.3.1.7.2','Issuer and Serial in the signer info corresponds to the issuer and serial values in the signer certificate','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(304, NULL,'10.3.1.8','Verify Digest Algorithm in SignerInfo','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(305, NULL,'10.3.1.8.1','The digestAlgorithm field value of the SignerInfo is in accordance with Table 3-2 of SP 800-78','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(306, NULL,'10.3.1.8.2','digestAlgorithm field value of the SignerInfo matches the value present in the digestAlgorithms field of the SignedData.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(307, NULL,'10.3.1.9','Message digest from signed attributes bag matches the digest over Facial Image biometric data (excluding contents of digital signature field)','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(308, NULL,'10.3.1.10','Value of the subject DN obtained from the certificate in the certificates field in the SignedData is identical to that obtained from the pivSigner-DN attribute of the signedAttrs of the SignerInfo.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(309, NULL,'10.3.1.11','Signature algorithm value for RSA with PKCS #1 v1.5 padding specifies the rsaEncryption OID (as per Section 3.2 of RFC 3370) and for ECDSA and RSA with PSS padding, the signatureAlgorithm is in accordance with Table 3-3 of SP80078.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(310, NULL,'10.3.1.12','Certificates field in the SignedData contains a single certificate that can be used to verify the digital signature in the SignerInfo. If the certificates field is omitted, then the certificates field of the SignedData for the CHUID contains the certificate that can be used to verify the digital signature.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(311, NULL,'10.3.1.13','The content signing certificate contains id-piv-content-signing or directly-asserted id-fpki-pivi-content-signing (for PIV-I) EKU extension.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(312, NULL,'10.3.1.15','The signed attribute entryUUID matches GUID read from CHUID container.','CARDHOLDER_FACIAL_IMAGE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(313, NULL,'10.4 Security Object','Security Object','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(314, NULL,'10.4.1','Data Integrity','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(315, NULL,'10.4.1.1','The actual hash of the data elements on the PIV card are identical to their corresponding hash values present in the security object.','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(316, NULL,'10.4.2','Signature Block Contents','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(317, NULL,'10.4.2.1','Verify that the asymmetric digital field contains a CMS signed data object','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(318, NULL,'10.4.2.2','Confirm that version of signed data structure is 1','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(319, NULL,'10.4.2.3','Verify that eContent contains a security object','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(320, NULL,'10.4.2.4','The eContent field contains a correctly formatted ldsSecurityobject and the eContentType asserts id-icao-ldsSecurityObject in encapContentInfo.','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(321, NULL,'10.4.2.5','The certificates field is omitted from the SignedData.','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(322, NULL,'10.4.2.6','digestAlgorithm field value of the SignerInfo is in accordance with Table 3-2 of SP 800-78','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(323, NULL,'10.4.2.7','The signatureAlgorithm field specified in the SignerInfo field for RSA with PKCS #1 v1.5 padding specifies the rsaEncryption OID (as per Section 3.2 of RFC 3370) and for ECDSA and RSA with PSS padding, the signatureAlgorithm shall be in accordance with Table 3-3 of SP80078.','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(324, NULL,'10.4.2.8','The signature in the SignerInfo corresponds to the signed security object and that it is it signed with the certificate that is used to sign the CHUID.','SECURITY_OBJECT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(325, NULL,'10.5 Iris','Biometric Iris','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(326, NULL,'10.5.1','Signature Block Contents','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(327, NULL,'10.5.1.1','CBEFF_SIGNATURE_BLOCK is present in the biometric CBEFF structure containing an asymmetric digital signature that is implemented as a SignedData type according to RFC 5652.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(328, NULL,'10.5.1.2','PKCS#7 version is set to 3','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(329, NULL,'10.5.1.3','digestAlgorithms field value of the SignedData is in accordance with Table 3-2 of SP80078.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(330, NULL,'10.5.1.4','Encapsulated content is absent and eContentType is id-PIV-CHUIDSecurityObject for CHUID and id-PIV-biometricObject for biometric objects in encapContentInfo','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(331, NULL,'10.5.1.5','The crls field is omitted from the SignedData.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(332, NULL,'10.5.1.6','The signerInfos field in the SignedData contains a single SignerInfo.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(333, NULL,'10.5.1.6.1','SignerId uses ths IssuerAndSerialNumber choice','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(334, NULL,'10.5.1.6.2','Issuer and Serial in the signer info corresponds to the issuer and serial values in the signer certificate','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(335, NULL,'10.5.1.7','Verify Digest Algorithm in SignerInfo','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(336, NULL,'10.5.1.7.1','digestAlgorithm field value of the SignerInfo is in accordance with Table 3-2 of SP 800-78','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(337, NULL,'10.5.1.7.2','digestAlgorithm field value of the SignerInfo matches the value present in the digestAlgorithms field of the SignedData.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(338, NULL,'10.5.1.8','Message digest from signed attributes bag matches the digest over Fingerprint biometric data (excluding contents of digital signature field)','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(339, NULL,'10.5.1.9','Value of the subject DN obtained from the certificate in the certificates field in the SignedData is identical to that obtained from the pivSigner-DN attribute of the signedAttrs of the SignerInfo.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(340, NULL,'10.5.1.10','Signature algorithm value for RSA with PKCS #1 v1.5 padding specifies the rsaEncryption OID (as per Section 3.2 of RFC 3370) and for ECDSA and RSA with PSS padding, the signatureAlgorithm is in accordance with Table 3-3 of SP80078.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(341, NULL,'10.5.1.11','Certificates field in the SignedData contains a single certificate that can be used to verify the digital signature in the SignerInfo. If the certificates field is omitted, then the certificates field of the SignedData for the CHUID contains the certificate that can be used to verify the digital signature.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(342, NULL,'10.5.1.12','The content signing certificate contains id-piv-content-signing or directly-asserted id-fpki-pivi-content-signing (for PIV-I) EKU extension.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(343, NULL,'10.5.1.14','The signed attribute entryUUID matches GUID read from CHUID container.','CARDHOLDER_IRIS_IMAGES_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(344, NULL,'11 X.509 Certificate Profiles','PKI Certificate Profile Test Assertions','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(345, NULL,'11.1 PIV Auth Cert','PIV Authentication Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(346, NULL,'11.1.1','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(347, NULL,'11.1.1.1','The signatureAlgorithm value is in accordance with Table 3-3 of SP80078. If the algorithm value is id-RSASSA-PSS, verify that the signature->parameters field is populated with SHA-256 (OID = 2.16.840.1.101.3.4.2.1). For the other RSA algorithms, the parameters field is populated with NULL. For ECDSA, the parameters field is absent.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(348, NULL,'11.1.1.2','The PIV authentication key is generated using an allowed asymmetric key algorithm.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
...
INSERT INTO "TestCases" VALUES(356, NULL,'11.1.2.2.1','A policyIdentifier field in the certificatePolicies extension asserts id-fpki-common-authentication.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(357, NULL,'11.1.2.3','OCSP','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(358, NULL,'11.1.2.3.1','authorityInformationAccess extension is present','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(359, NULL,'11.1.2.3.2','An accessMethod containing id-ad-ocsp is present.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(360, NULL,'11.1.2.3.3','AIA uniformResourceIdentifier protocol is http','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(361, NULL,'11.1.2.5','Private key corresponds to the public key contained in the certificate as the signature verification succeeds.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(362, NULL,'11.1.2.6','Subject Alternate Name','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(363, NULL,'11.1.2.6.2','GeneralName field exists that contain a URI asserting a Card UUID as specified by [RFC4122, Section 3] that matches the GUID value in the CHUID.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(364, NULL,'11.1.2.7','Expiration date of the PIV authentication certificate is not beyond the expiration date of the CHUID i.e. the PIV card.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(365, NULL,'11.1.2.8','Exponent of the RSA asymmetric key for PIV authentication is equal to 65,537.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(366, NULL,'11.1.2.9','CRL Distribution Point','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(367, NULL,'11.1.2.9.1','URI is present with the http scheme.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(368, NULL,'11.1.2.9.2','URI points only to files with .crl extensions.','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(369, NULL,'11.1.2.10','Authority Information Access','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(370, NULL,'11.1.2.10.1','authorityInformationAccess extension is present','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(371, NULL,'11.1.2.10.2','An accessMethod containing id-ad-caIssuers is present','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(372, NULL,'11.1.2.10.3','The accessLocation for this AccessMethod is of type uniformResourceIdentifier','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(373, NULL,'11.1.2.10.4','URI scheme is http (not https)','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(374, NULL,'11.1.2.10.5','File contains a CMS a certs-only CMS message (see RFC 3851).','X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(375, NULL,'11.2 Digital Signature Cert','Digital Signature Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(376, NULL,'11.2.1','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(377, NULL,'11.2.1.1','The signatureAlgorithm value is in accordance with Table 3-3 of SP80078. If the algorithm value is id-RSASSA-PSS, verify that the signature->parameters field is populated with SHA-256 (OID = 2.16.840.1.101.3.4.2.1). For the other RSA algorithms, the parameters field is populated with NULL. For ECDSA, the parameters field is absent.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(378, NULL,'11.2.1.2','The digital signature key is generated using an allowed asymmetric key algorithm.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(379, NULL,'11.2.1.3','The key size used is in accordance with Table 3-1 of SP80078.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(380, NULL,'11.2.2','Data Integrity Checks','',NULL, 1, 1);
...
INSERT INTO "TestCases" VALUES(388, NULL,'11.2.2.5','policyIdentifier field in the certificatePolicies extension asserts one of the following: id-fpki-common-hardware or id-fpki-common-High.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(389, NULL,'11.2.2.6','CRL Distribution Point','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(390, NULL,'11.2.2.6.1','URI is present with the http scheme.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(391, NULL,'11.2.2.6.2','URI points only to files with .crl extensions.','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(392, NULL,'11.2.2.7','Authority Information Access','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(393, NULL,'11.2.2.7.1','authorityInformationAccess extension is present','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(394, NULL,'11.2.2.7.2','authorityInfoAccess field contains an id-ad-caIssuers','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(395, NULL,'11.2.2.7.3','The accessLocation for this AccessMethod is of type uniformResourceIdentifier','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(396, NULL,'11.2.2.7.4','URI scheme is http (not https)','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(397, NULL,'11.2.2.7.5','File contains a CMS a certs-only CMS message (see RFC 3851).','X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(398, NULL,'11.3 Key Management Cert','Key Management Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(399, NULL,'11.3.1','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(400, NULL,'11.3.1.1','If the algorithm value is id-RSASSA-PSS, verify that the signature->parameters field is populated with SHA-256 (OID = 2.16.840.1.101.3.4.2.1). For the other RSA algorithms, the parameters field is populated with NULL. For ECDSA, the parameters field is absent.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(401, NULL,'11.3.1.2','The key management key is generated using an allowed asymmetric key algorithm.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
...
INSERT INTO "TestCases" VALUES(409, NULL,'11.3.2.2','The private key corresponds to the public key contained in the certificate as the signature verification succeeds.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(410, NULL,'11.3.2.3','Exponent of the RSA asymmetric key for key management is equal to 65,537.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(411, NULL,'11.3.2.4','policyIdentifier field in the certificatePolicies extension asserts one of the following: id-fpki-common-hardware or id-fpki-common-High.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(412, NULL,'11.3.2.5','CRL Distribution Point','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(413, NULL,'11.3.2.5.1','URI is present with the http scheme.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(414, NULL,'11.3.2.5.2','URI points only to files with .crl extensions.','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(415, NULL,'11.3.2.6','Authority Information Access','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(416, NULL,'11.3.2.6.1','authorityInformationAccess extension is present','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(417, NULL,'11.3.2.6.2','authorityInfoAccess field contains an id-ad-caIssuers','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(418, NULL,'11.3.2.6.3','The accessLocation for this AccessMethod is of type uniformResourceIdentifier','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(419, NULL,'11.3.2.6.4','URI scheme is http (not https)','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(420, NULL,'11.3.2.6.5','File contains a CMS a certs-only CMS message (see RFC 3851).','X509_CERTIFICATE_FOR_KEY_MANAGEMENT_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(421, NULL,'11.4 Card Auth Cert','Card Authentication Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(422, NULL,'11.4.1','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(423, NULL,'11.4.1.1','If the algorithm value is id-RSASSA-PSS, verify that the signature->parameters field is populated with SHA-256 (OID = 2.16.840.1.101.3.4.2.1). For the other RSA algorithms, the parameters field is populated with NULL. For ECDSA, the parameters field is absent.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(424, NULL,'11.4.1.2','The card authentication key is generated using the allowed asymmetric key algorithm.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(425, NULL,'11.4.1.3','The key sizes used are in accordance with Table 3-1 of SP80078.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(426, NULL,'11.4.2','Data Integrity Checks','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(427, NULL,'11.4.2.1','Key Usage','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(428, NULL,'11.4.2.1.1','Key Usage extension is present','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(429, NULL,'11.4.2.1.2','The digitalSignature bit has been set.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(430, NULL,'11.4.2.1.3','No other bits have been set.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(431, NULL,'11.4.2.2','policyIdentifier field in the certificatePolicies extension asserts id-fpki-common-cardAuth.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(432, NULL,'11.4.2.3','Extended Key Usage','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(433, NULL,'11.4.2.3.1','Extended key usage (extKeyUsage) extension is present and maked critical','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(434, NULL,'11.4.2.3.2','Extended key usage (extKeyUsage) extension asserts id-PIV-cardAuth','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(435, NULL,'11.4.2.3.3','Extended key usage extension does not assert any other OIDs.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(436, NULL,'11.4.2.4','Authority Information Access','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(437, NULL,'11.4.2.4.1','authorityInformationAccess extension is present','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(438, NULL,'11.4.2.4.2','authorityInfoAccess field contains an id-ad-ocsp','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(439, NULL,'11.4.2.4.3','The accessLocation for this AccessMethod is of type uniformResourceIdentifier','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(440, NULL,'11.4.2.4.4','URI scheme is http (not https)','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(441, NULL,'11.4.2.6','The private key corresponds to the public key contained in the certificate as the signature verification succeeds.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(442, NULL,'11.4.2.7','Subject Alternate Name','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(443, NULL,'11.4.2.7.2','GeneralName field exists that contain a URI asserting a Card UUID as specified by [RFC4122, Section 3] that matches the GUID value in the CHUID.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(444, NULL,'11.4.2.7.3','No other name forms appear in the subjectAltName extension.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(445, NULL,'11.4.2.8','Exponent of the RSA asymmetric key for key management is equal to 65,537.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(446, NULL,'11.4.2.9','CRL Distribution Point','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(447, NULL,'11.4.2.9.1','URI is present with the http scheme.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(448, NULL,'11.4.2.9.2','URI points only to files with .crl extensions.','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(449, NULL,'11.4.2.10','Authority Information Access (85B-4)','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(450, NULL,'11.4.2.10.5','File contains a CMS a certs-only CMS message (see RFC 3851).','X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(451, NULL,'11.5 Secure Messaging CVC','Secure Messaging Card Verifiable Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(452, NULL,'11.5.1','Secure Messaging CVC Profile Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(453, NULL,'11.5.2','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(454, NULL,'11.5.3','Data Integrity Checks','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(455, NULL,'11.6 Intermediate CVC','Intermediate Card Verifiable Certificate','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(456, NULL,'11.6.1','Intermediate CVC Profile Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(457, NULL,'11.6.2','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(458, NULL,'11.7 Content Signing Cert','X.509 Certificate for Content Signing','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(459, NULL,'11.7.1','Algorithm Conformance','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(460, NULL,'11.7.1.1','If the algorithm value is id-RSASSA-PSS, verify that the signature->parameters field is populated with SHA-256 (OID = 2.16.840.1.101.3.4.2.1). For the other RSA algorithms, the parameters field is populated with NULL. For ECDSA, the parameters field is absent.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(461, NULL,'11.7.1.2','The card authentication key is generated using the allowed asymmetric key algorithm.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
...
INSERT INTO "TestCases" VALUES(469, NULL,'11.7.2.3','Exponent of the RSA asymmetric key for the X.509 Certificate for Content Signing is equal to 65,537.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(470, NULL,'11.7.2.4','Certificate Policy and Extended Key Usage','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(471, NULL,'11.7.2.4.1','policyIdentifier field in the certificatePolicies extension asserts the id-fpki-common-piv-contentSigning policy of [COMMON] (OID = 2.16.840.1.101.3.2.1.3.39)','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(472, NULL,'11.7.2.4.2','extended key usage (extKeyUsage) asserts id-PIV-content-signing.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(473, NULL,'11.7.2.5','CRL Distribution Point','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(474, NULL,'11.7.2.5.1','URI is present with the http scheme.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(475, NULL,'11.7.2.5.2','URI points only to files with .crl extensions.','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(476, NULL,'11.7.2.6','Authority Information Access','',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(477, NULL,'11.7.2.6.1','authorityInformationAccess extension is present','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(478, NULL,'11.7.2.6.2','authorityInfoAccess field contains an id-ad-caIssuers','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(479, NULL,'11.7.2.6.3','The accessLocation for this AccessMethod is of type uniformResourceIdentifier','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(480, NULL,'11.7.2.6.4','URI scheme is http (not https)','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
INSERT INTO "TestCases" VALUES(481, NULL,'11.7.2.6.5','File contains a CMS a certs-only CMS message (see RFC 3851).','CARD_HOLDER_UNIQUE_IDENTIFIER_OID',NULL, 1, 1);
...
INSERT INTO "TestsToSteps" VALUES(141, 106,173,0,NULL);
INSERT INTO "TestsToSteps" VALUES(142, 107,174,0,NULL);
INSERT INTO "TestsToSteps" VALUES(143, 61,177,0,NULL);
INSERT INTO "TestsToSteps" VALUES(144, 62,178,0,NULL);
INSERT INTO "TestsToSteps" VALUES(145, 63,179,0,NULL);
INSERT INTO "TestsToSteps" VALUES(146, 109,180,0,NULL);
INSERT INTO "TestsToSteps" VALUES(147, 65,182,0,NULL);
INSERT INTO "TestsToSteps" VALUES(148, 66,183,0,NULL);
INSERT INTO "TestsToSteps" VALUES(149, 67,184,0,NULL);
INSERT INTO "TestsToSteps" VALUES(150, 99,185,0,NULL);
INSERT INTO "TestsToSteps" VALUES(151, 100,186,0,NULL);
INSERT INTO "TestsToSteps" VALUES(152, 64,187,0,NULL);
INSERT INTO "TestsToSteps" VALUES(153, 102,188,0,NULL);
INSERT INTO "TestsToSteps" VALUES(154, 103,189,0,NULL);
INSERT INTO "TestsToSteps" VALUES(155, 104,190,0,NULL);
INSERT INTO "TestsToSteps" VALUES(156, 105,191,0,NULL);
INSERT INTO "TestsToSteps" VALUES(157, 106,192,0,NULL);
...
INSERT INTO "TestsToSteps" VALUES(173, 106,211,0,NULL);
...
INSERT INTO "TestsToSteps" VALUES(218, 131,269,0,NULL);
INSERT INTO "TestsToSteps" VALUES(219, 133,270,0,NULL);
INSERT INTO "TestsToSteps" VALUES(220, 120,271,0,NULL);
INSERT INTO "TestsToSteps" VALUES(221, 121,272,0,NULL);
INSERT INTO "TestsToSteps" VALUES(222, 122,273,0,NULL);
INSERT INTO "TestsToSteps" VALUES(223, 123,274,0,NULL);
INSERT INTO "TestsToSteps" VALUES(224, 110,277,0,NULL);
INSERT INTO "TestsToSteps" VALUES(225, 111,278,0,NULL);
INSERT INTO "TestsToSteps" VALUES(226, 112,279,0,NULL);
INSERT INTO "TestsToSteps" VALUES(227, 114,280,0,NULL);
INSERT INTO "TestsToSteps" VALUES(228, 115,281,0,NULL);
INSERT INTO "TestsToSteps" VALUES(229, 116,282,0,NULL);
INSERT INTO "TestsToSteps" VALUES(230, 117,283,0,NULL);
INSERT INTO "TestsToSteps" VALUES(231, 118,284,0,NULL);
INSERT INTO "TestsToSteps" VALUES(232, 131,286,0,NULL);
INSERT INTO "TestsToSteps" VALUES(233, 133,287,0,NULL);
INSERT INTO "TestsToSteps" VALUES(234, 120,288,0,NULL);
INSERT INTO "TestsToSteps" VALUES(235, 121,289,0,NULL);
INSERT INTO "TestsToSteps" VALUES(236, 122,290,0,NULL);
INSERT INTO "TestsToSteps" VALUES(237, 123,291,0,NULL);
INSERT INTO "TestsToSteps" VALUES(238, 124,292,0,NULL);
INSERT INTO "TestsToSteps" VALUES(239, 138,293,0,NULL);
INSERT INTO "TestsToSteps" VALUES(240, 110,296,0,NULL);
INSERT INTO "TestsToSteps" VALUES(241, 111,297,0,NULL);
INSERT INTO "TestsToSteps" VALUES(242, 112,298,0,NULL);
INSERT INTO "TestsToSteps" VALUES(243, 114,299,0,NULL);
INSERT INTO "TestsToSteps" VALUES(244, 115,300,0,NULL);
INSERT INTO "TestsToSteps" VALUES(245, 116,301,0,NULL);
INSERT INTO "TestsToSteps" VALUES(246, 117,302,0,NULL);
INSERT INTO "TestsToSteps" VALUES(247, 118,303,0,NULL);
INSERT INTO "TestsToSteps" VALUES(248, 131,305,0,NULL);
INSERT INTO "TestsToSteps" VALUES(249, 133,306,0,NULL);
INSERT INTO "TestsToSteps" VALUES(250, 120,307,0,NULL);
INSERT INTO "TestsToSteps" VALUES(251, 121,308,0,NULL);
INSERT INTO "TestsToSteps" VALUES(252, 122,309,0,NULL);
INSERT INTO "TestsToSteps" VALUES(253, 123,310,0,NULL);
INSERT INTO "TestsToSteps" VALUES(254, 124,311,0,NULL);
INSERT INTO "TestsToSteps" VALUES(255, 138,312,0,NULL);
INSERT INTO "TestsToSteps" VALUES(256, 42,315,0,NULL);
INSERT INTO "TestsToSteps" VALUES(257, 119,317,0,NULL);
INSERT INTO "TestsToSteps" VALUES(258, 126,318,0,NULL);
INSERT INTO "TestsToSteps" VALUES(259, 127,319,0,NULL);
INSERT INTO "TestsToSteps" VALUES(260, 128,320,0,NULL);
INSERT INTO "TestsToSteps" VALUES(261, 129,321,0,NULL);
INSERT INTO "TestsToSteps" VALUES(262, 131,322,0,NULL);
INSERT INTO "TestsToSteps" VALUES(263, 122,323,0,NULL);
INSERT INTO "TestsToSteps" VALUES(264, 123,324,0,NULL);
INSERT INTO "TestsToSteps" VALUES(265, 110,327,0,NULL);
INSERT INTO "TestsToSteps" VALUES(266, 111,328,0,NULL);
INSERT INTO "TestsToSteps" VALUES(267, 113,329,0,NULL);
INSERT INTO "TestsToSteps" VALUES(268, 114,330,0,NULL);
INSERT INTO "TestsToSteps" VALUES(269, 115,331,0,NULL);
INSERT INTO "TestsToSteps" VALUES(270, 116,332,0,NULL);
INSERT INTO "TestsToSteps" VALUES(271, 117,333,0,NULL);
INSERT INTO "TestsToSteps" VALUES(272, 118,334,0,NULL);
INSERT INTO "TestsToSteps" VALUES(273, 131,336,0,NULL);
INSERT INTO "TestsToSteps" VALUES(274, 133,337,0,NULL);
INSERT INTO "TestsToSteps" VALUES(275, 120,338,0,NULL);
INSERT INTO "TestsToSteps" VALUES(276, 121,339,0,NULL);
INSERT INTO "TestsToSteps" VALUES(277, 122,340,0,NULL);
INSERT INTO "TestsToSteps" VALUES(278, 123,341,0,NULL);
INSERT INTO "TestsToSteps" VALUES(279, 124,342,0,NULL);
INSERT INTO "TestsToSteps" VALUES(280, 138,343,0,NULL);
INSERT INTO "TestsToSteps" VALUES(281, 141,347,0,NULL);
INSERT INTO "TestsToSteps" VALUES(282, 139,348,0,NULL);
INSERT INTO "TestsToSteps" VALUES(283, 139,349,0,NULL);
INSERT INTO "TestsToSteps" VALUES(284, 143,352,0,NULL);
INSERT INTO "TestsToSteps" VALUES(285, 145,353,0,NULL);
INSERT INTO "TestsToSteps" VALUES(286, 145,354,0,NULL);
INSERT INTO "TestsToSteps" VALUES(287, 146,355,0,NULL);
INSERT INTO "TestsToSteps" VALUES(288, 147,356,0,NULL);
INSERT INTO "TestsToSteps" VALUES(289, 148,358,0,NULL);
INSERT INTO "TestsToSteps" VALUES(290, 149,359,0,NULL);
INSERT INTO "TestsToSteps" VALUES(291, 164,360,0,NULL);
INSERT INTO "TestsToSteps" VALUES(292, 152,361,0,NULL);
INSERT INTO "TestsToSteps" VALUES(293, 168,363,0,NULL);
INSERT INTO "TestsToSteps" VALUES(294, 154,364,0,NULL);
INSERT INTO "TestsToSteps" VALUES(295, 155,365,0,NULL);
INSERT INTO "TestsToSteps" VALUES(296, 150,367,0,NULL);
INSERT INTO "TestsToSteps" VALUES(297, 165,368,0,NULL);
INSERT INTO "TestsToSteps" VALUES(298, 148,370,0,NULL);
INSERT INTO "TestsToSteps" VALUES(299, 163,371,0,NULL);
INSERT INTO "TestsToSteps" VALUES(300, 150,372,0,NULL);
INSERT INTO "TestsToSteps" VALUES(301, 164,373,0,NULL);
INSERT INTO "TestsToSteps" VALUES(302, 166,374,0,NULL);
INSERT INTO "TestsToSteps" VALUES(303, 141,377,0,NULL);
INSERT INTO "TestsToSteps" VALUES(304, 139,378,0,NULL);
INSERT INTO "TestsToSteps" VALUES(305, 139,379,0,NULL);
INSERT INTO "TestsToSteps" VALUES(306, 143,382,0,NULL);
INSERT INTO "TestsToSteps" VALUES(307, 145,383,0,NULL);
INSERT INTO "TestsToSteps" VALUES(308, 145,384,0,NULL);
INSERT INTO "TestsToSteps" VALUES(309, 152,385,0,NULL);
INSERT INTO "TestsToSteps" VALUES(310, 154,386,0,NULL);
INSERT INTO "TestsToSteps" VALUES(311, 155,387,0,NULL);
INSERT INTO "TestsToSteps" VALUES(312, 147,388,0,NULL);
INSERT INTO "TestsToSteps" VALUES(313, 150,390,0,NULL);
INSERT INTO "TestsToSteps" VALUES(314, 165,391,0,NULL);
INSERT INTO "TestsToSteps" VALUES(315, 148,393,0,NULL);
INSERT INTO "TestsToSteps" VALUES(316, 163,394,0,NULL);
INSERT INTO "TestsToSteps" VALUES(317, 150,395,0,NULL);
INSERT INTO "TestsToSteps" VALUES(318, 164,396,0,NULL);
INSERT INTO "TestsToSteps" VALUES(319, 166,397,0,NULL);
INSERT INTO "TestsToSteps" VALUES(320, 141,400,0,NULL);
INSERT INTO "TestsToSteps" VALUES(321, 139,401,0,NULL);
INSERT INTO "TestsToSteps" VALUES(322, 139,402,0,NULL);
INSERT INTO "TestsToSteps" VALUES(323, 143,405,0,NULL);
INSERT INTO "TestsToSteps" VALUES(324, 145,406,0,NULL);
INSERT INTO "TestsToSteps" VALUES(325, 145,407,0,NULL);
INSERT INTO "TestsToSteps" VALUES(326, 145,408,0,NULL);
INSERT INTO "TestsToSteps" VALUES(327, 152,409,0,NULL);
INSERT INTO "TestsToSteps" VALUES(328, 155,410,0,NULL);
INSERT INTO "TestsToSteps" VALUES(329, 147,411,0,NULL);
INSERT INTO "TestsToSteps" VALUES(330, 150,413,0,NULL);
INSERT INTO "TestsToSteps" VALUES(331, 165,414,0,NULL);
INSERT INTO "TestsToSteps" VALUES(332, 148,416,0,NULL);
INSERT INTO "TestsToSteps" VALUES(333, 163,417,0,NULL);
INSERT INTO "TestsToSteps" VALUES(334, 150,418,0,NULL);
INSERT INTO "TestsToSteps" VALUES(335, 164,419,0,NULL);
INSERT INTO "TestsToSteps" VALUES(336, 166,420,0,NULL);
INSERT INTO "TestsToSteps" VALUES(337, 141,423,0,NULL);
INSERT INTO "TestsToSteps" VALUES(338, 139,424,0,NULL);
INSERT INTO "TestsToSteps" VALUES(339, 139,425,0,NULL);
INSERT INTO "TestsToSteps" VALUES(340, 143,428,0,NULL);
INSERT INTO "TestsToSteps" VALUES(341, 145,429,0,NULL);
INSERT INTO "TestsToSteps" VALUES(342, 145,430,0,NULL);
INSERT INTO "TestsToSteps" VALUES(343, 147,431,0,NULL);
INSERT INTO "TestsToSteps" VALUES(344, 160,433,0,NULL);
INSERT INTO "TestsToSteps" VALUES(345, 161,434,0,NULL);
INSERT INTO "TestsToSteps" VALUES(346, 161,435,0,NULL);
...
INSERT INTO "TestsToSteps" VALUES(350, 150,440,0,NULL);
INSERT INTO "TestsToSteps" VALUES(351, 152,441,0,NULL);
INSERT INTO "TestsToSteps" VALUES(352, 168,443,0,NULL);
INSERT INTO "TestsToSteps" VALUES(353, 169,444,0,NULL);
INSERT INTO "TestsToSteps" VALUES(354, 155,445,0,NULL);
INSERT INTO "TestsToSteps" VALUES(355, 150,447,0,NULL);
INSERT INTO "TestsToSteps" VALUES(356, 165,448,0,NULL);
INSERT INTO "TestsToSteps" VALUES(357, 166,450,0,NULL);
INSERT INTO "TestsToSteps" VALUES(358, 141,460,0,NULL);
INSERT INTO "TestsToSteps" VALUES(359, 139,461,0,NULL);
INSERT INTO "TestsToSteps" VALUES(360, 139,462,0,NULL);
INSERT INTO "TestsToSteps" VALUES(361, 143,465,0,NULL);
INSERT INTO "TestsToSteps" VALUES(362, 145,466,0,NULL);
INSERT INTO "TestsToSteps" VALUES(363, 145,467,0,NULL);
INSERT INTO "TestsToSteps" VALUES(364, 167,468,0,NULL);
INSERT INTO "TestsToSteps" VALUES(365, 155,469,0,NULL);
INSERT INTO "TestsToSteps" VALUES(366, 147,471,0,NULL);
INSERT INTO "TestsToSteps" VALUES(367, 161,472,0,NULL);
INSERT INTO "TestsToSteps" VALUES(368, 150,474,0,NULL);
INSERT INTO "TestsToSteps" VALUES(369, 165,475,0,NULL);
INSERT INTO "TestsToSteps" VALUES(370, 148,477,0,NULL);
INSERT INTO "TestsToSteps" VALUES(371, 149,478,0,NULL);
INSERT INTO "TestsToSteps" VALUES(372, 150,479,0,NULL);
INSERT INTO "TestsToSteps" VALUES(373, 164,480,0,NULL);
INSERT INTO "TestsToSteps" VALUES(374, 166,481,0,NULL);
