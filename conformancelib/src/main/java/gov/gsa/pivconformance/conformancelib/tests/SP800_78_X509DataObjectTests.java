...
public class SP800_78_X509DataObjectTests {
     ...
     * X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID:1.2.840.113549.1.1.1+NULL|1.2.
     * 840.10045.2.1+1.2.840.10045.3.1.7,
     * X509_CERTIFICATE_FOR_DIGITAL_CERTIFICATE_OID:1.2.840.113549.1.1.1+NULL|1.2.
     ...
     * -----------------------------------+-----------------------------------------
     * ------ Asymmetric Card Authentication key | RSA (2048 bits) | ECDSA (Curve
     * P-256)
     * -----------------------------------+-----------------------------------------
     * ------ Symmetric Card Authentication key | 3TDEA3 AES-128, AES-192, or
     * AES-256
     * -----------------------------------+-----------------------------------------
     * ------ Digital signature key | RSA (2048 bits) | ECDSA (Curve P-256 or P-384)
     * -----------------------------------+-----------------------------------------
     * ------ Key Management Key | RSA key transport (2048 bits); | ECDH (Curve
     * P-256 or P-384)
     * -----------------------------------+-----------------------------------------
    ...
    // ansip256r1 ::= { iso(1) member-body(2) us(840) ansi-X9-62(10045) curves(3)
    // prime(1) 7 }
    ...
    /*
     * The signatureAlgorithm value is in accordance with Table 3-3 of SP80078. If
     * the algorithm value is id-RSASSA-PSS, verify that the signature->parameters
