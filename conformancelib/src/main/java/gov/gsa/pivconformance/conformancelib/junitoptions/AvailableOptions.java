...
class AvailableOptions {
	...
	private final Details details = CommandLineOptions.DEFAULT_DETAILS;

	@Option(names = "-details", hidden = true)
	private final Details details2 = CommandLineOptions.DEFAULT_DETAILS;
	...
	private final Theme theme = CommandLineOptions.DEFAULT_THEME;

	@Option(names = "-details-theme", hidden = true)
	private final Theme theme2 = CommandLineOptions.DEFAULT_THEME;
