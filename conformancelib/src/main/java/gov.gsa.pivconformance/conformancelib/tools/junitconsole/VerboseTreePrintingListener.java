...
public class VerboseTreePrintingListener implements TestExecutionListener {
	...
	public VerboseTreePrintingListener(PrintWriter out, boolean disableAnsiColors, int maxContainerNestingLevel, gov.gsa.pivconformance.conformancelib.junitoptions.Theme theme2) {
		this.out = out;
